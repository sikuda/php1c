...
*/
const php1C_types_Collection = array('МАСИВ','СТРУКТУРА','ВІДПОВІДНІСТЬ','ТАБЛИЦЯЗНАЧЕННЯ');
...
*/
//const php1C_functions_String_RU = array('СТРДЛИНА(','СОКРЛ(','СОКРП(','СОКРЛП(','ЛЕВ(','ПРАВ(','СРЕД(','СТРНАЙТИ(','НРЕГ(','ВРЕГ(', 'ТРЕГ(', 'СИМВОЛ(','КОДСИМВОЛА(','ПУСТАЯСТРОКА(','СТРЗАМЕНИТЬ(','СТРЧИСЛОСТРОК(','СТРПОЛУЧИТЬСТРОКУ(','СТРЧИСЛОВХОЖДЕНИЙ(', 'СТРСРАВНИТЬ(','СТРНАЧИНАЕТСЯС(','СТРЗАКАНЧИВАЕТСЯНА(', 'СТРРАЗДЕЛИТЬ(', 'СТРСОЕДИНИТЬ(');

const php1C_functions_String = array('СТРДЛІНА(','СКОРОЛ(','СКОРОП(','СКОРОЛП(','ЛІВ(','ПРАВ(','СЕРЕД(','СТРЗНАЙТИ(','НРЕГ(','ВРЕГ(', ')) ТРЕГ(', 'СИМВОЛ(','КОДСИМВОЛУ(','ПОРОЖНЯСТРІЧКА(','СТРЗАМІНИТИ(','СТРЧИСЛОРЯДКІВ(','СТРПОЛУЧИТЬРЯДКУ(','СТРЧИСЛОПОХОДЖЕНЬ(', 'РЯДОКПОРІВНЯТИ(','РЯДОКПОЧИНАЄТЬСЯЗ(', 'РЯДОКЗАКІНЧУЄТЬСЯНА(', 'СТРАЗДІЛИТИ(', 'СТРСПОЛУЧИТИ(');
...
const php1C_error_BadDateType      = 'Неправильна константа типу Дата';
